---
title: "Introduction optiDoseR"
output:
  html_document:
    includes:
      before_body: include_tutorials_nav.html
bibliography: ./References/optiDoseR_references.bib
---
...
```{r, eval=F}
warf_proj <- warf_proj %>%
  addPmxRun(pmx_file = "warfarinPKPD_project.mlxtran")
```
...
```{r,include=F}
sim_data <- read.table("./Files/simulation_mlx_warfarin_optProject_typical/Simulation/simulatedData.txt", sep=",", header = T) %>%
  filter(obs != ".") %>%
